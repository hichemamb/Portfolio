...
var slide = document.querySelector(".Contact-slideItem");
var image = document.querySelector(".Contact-image");
var socialContainer = document.querySelector(".Contact-socialContainer");
var heroGang = document.querySelector('.Contact-text1');
var heroGang2 = document.querySelector('.Contact-text2');
var width = 0;
//var padding = 0;
...
window.addEventListener('keydown', function (event) {
  if (event.which === 39) {
    ...
    slide.style.paddingRight = '100px';
    slide.style.transition = 'all 2s ease';
    heroGang.style.display = 'block';
    heroGang.style.width = '400px';
    heroGang2.style.display = 'block';
    heroGang2.style.width = '400px';
  }
});
